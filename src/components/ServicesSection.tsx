...
export default function ServicesSection() {
  return (
    <section
      id="services"
      className="px-4 lg:px-20 flex flex-col lg:flex-row justify-between gap-6 lg:gap-0"
    >
      <div>
        <div className="lg:sticky lg:top-24">
          <h2 className="text-primary-50 font-display font-semibold text-display-4 lg:text-display-2 leading-none">
            Diensten
          </h2>
      ...
      <div className="space-y-6 lg:space-y-24 lg:w-1/2 overflow-x-hidden">
        <ScrollIn>
          <ServiceCard
            type="Web | Dekstop"
            name="Webapplicaties"
            ...
            icon={
              <CodeBracketIcon className="text-accent-300 lg:w-10 lg:h-10 w-8 h-8" />
            }
          />
        </ScrollIn>
        ...
        <ScrollIn>
          <ServiceCard
            ...
            icon={
              <DevicePhoneMobileIcon className="text-accent-300 lg:w-10 lg:h-10 w-8 h-8" />
            }
          />
        </ScrollIn>
        <ScrollIn>
          <ServiceCard
            ...
            icon={<Globe className="text-accent-300 lg:w-10 lg:h-10 w-8 h-8" />}
          />
        </ScrollIn>
      </div>
    </section>
